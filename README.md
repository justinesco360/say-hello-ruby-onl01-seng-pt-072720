# Say Hello method and forget to give it the name of a person, it should just say, `"Hello Ruby Programmer!"`. Use a default argument to accomplish this!
...
There is one more thing this method should do: if you call on this
